...
app.get('/campgrounds', async (req, res) => {
    ...
    res.render('campgrounds/index', { campgrounds, title: 'All Campgrounds', hideFooter: true });
});

// // By default, show the footer for all routes: EXPRESS-EJS-LAYOUTS

// app.use((req, res, next) => {

//     // For ejs-mate use hideFooter:

//     // boilerplate.ejs
//     // <% if (typeof hideFooter === 'undefined' || hideFooter === false) { %> <%-
